...
Notes:
- This deployment seeds OpenClaw and the Codex/Discord plugins from the published npm packages pinned in the Dockerfile (`OPENCLAW_VERSION`, `OPENCLAW_CODEX_VERSION`, `OPENCLAW_DISCORD_VERSION`).
